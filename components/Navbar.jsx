      ...
      {isMobileMenuOpen && (
        <div className="" id="mobile-menu">
          <div className="space-y-1 px-2 pb-3 pt-2">
            <Link
              href="/"
              className={`${pathname === "/" ? "bg-gray-900" : ""} block rounded-md px-3 py-2 text-base font-medium text-white`}
            >
              Home
            </Link>
            <Link
              href="/properties"
              className={`${pathname === "/properties" ? "bg-gray-900" : ""} block rounded-md px-3 py-2 text-base font-medium text-white`}
            >
              Properties
            </Link>
            {isLoggedIn && (
